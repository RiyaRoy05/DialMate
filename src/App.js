  ...
  // State for passkey registration name
  ...
  const fetchContacts = async () => {
    ...
    try {
      ...
      // Send username/display_name to backend
      ...
      if (completeResponse.status === "success") {
        ...
        // Optionally save name for later use
    ...
    const handleAuthenticatePasskey = async () => {
      ...
      try {
        ...
        // Send an empty JSON body to satisfy backend expectations
  ...
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-blue-100 flex items-center justify-center p-4">
      <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg p-6 w-full max-w-md border border-gray-200">
        ...
        {/* Name input for passkey registration */}
        {!hasPasskey && (
          <div className="mb-4">
      ...
      const handleSave = async (form) => {
        try {
          ...
          if (editingContact && editingContact.id) {
            response = await fetch(`${API_BASE_URL}/contacts/${editingContact.id}/update/`, {
              method: "PUT",
              headers: {
